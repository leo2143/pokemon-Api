...
import com.pokemon_api.pokemon_api.mapper.PokemonTypeMapper;
...
@Data
public class PokemonTypeService extends DefaultService<PokemonTypeDto, PokemonTypeEntity, PokemonTypeCreateDto, PokemonTypeUpdateDto, Long> {
    ...
    public String getI8nMessage(String key, Object[] args) {
        return i18nUtil.getMessage("pokemon.type" + key, args);
    }
