...
@RequestMapping("level-learns")
@RestController
@AllArgsConstructor
@Tag(name = "Level learns Api", description = "Api orientada a brindar informacion las formas de aprendizaje")
@CrossOrigin(origins = "*", methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE, RequestMethod.PATCH})
public class LevelLearnsController {
