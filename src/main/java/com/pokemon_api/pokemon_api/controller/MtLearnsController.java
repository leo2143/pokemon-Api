...
@RequestMapping("mt-learns")
@RestController
@AllArgsConstructor
@Tag(name = "Mt learns Api", description = "Api orientada a brindar informacion las formas de aprendizaje mt")
@CrossOrigin(origins = "*", methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE, RequestMethod.PATCH})
public class MtLearnsController {
