...
@RequestMapping("secondary-effects")
@RestController
@AllArgsConstructor
@Tag(name = "Secondary effects Api", description = "Api orientada a brindar informacion acerca de los efectos secundarios de ataques")
...
public class SecondaryEffectsController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "#{" + I18nCodes.API_RESPONSE_CREATED + "}", content = @Content(schema = @Schema(implementation = SecondaryEffectsDto.class))), @ApiResponse(responseCode = "404", description = "#{" + I18nCodes.API_RESPONSE_NOT_FOUND + "}"), @ApiResponse(responseCode = "500", description = "#{" + I18nCodes.API_RESPONSE_INTERNAL_SERVER_ERROR + "}")})
