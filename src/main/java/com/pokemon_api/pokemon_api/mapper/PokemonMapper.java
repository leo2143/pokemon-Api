...
@Mapper(componentModel = MappingConstants.ComponentModel.SPRING, unmappedTargetPolicy = ReportingPolicy.WARN, uses = {PokemonTypeMapper.class, PokemonTypeMapperHelper.class,PokemonMapperHelper.class})
