...
(
    pokedex_number BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    name           VARCHAR(255),
...
(
    type_attack_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    name           VARCHAR(255),
...
(
    type_evolution_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    type_evolution    VARCHAR(255),
    CONSTRAINT pk_type_evolution PRIMARY KEY (type_evolution_id)
);

CREATE TABLE type_stone
(
    type_stone_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
ALTER TABLE pokemon_movement_form
    ADD CONSTRAINT FK_POKEMON_MOVEMENT_FORM_ON_ID_MOVEMENTS FOREIGN KEY (id_movements) REFERENCES movement_secondary_effects (id);
